...
def main():
    ...
    for i in range(5000):
        ...
        for idx, oid in enumerate(obs_ids):
            ...
            new_y = base[1] + 0.5 * np.sin(i * 0.002 + idx * 0.7)
            p.resetBasePositionAndOrientation(oid, [base[0],new_y,base[2]], [0,0,0,1])
            current_obs_positions.append([base[0], new_y, base[2]])
